...
import { Stack, Box, Text, StackDivider, Heading, VStack, SimpleGrid, Icon} from '@chakra-ui/react'
  ...
  return(
    <DashboardLayout>
      <Stack 
        ...
        divider={<StackDivider h={{base: 4, lg: "90vh"}} borderColor="whiteAlpha.200"/>}
      >
          <VStack pt={8} align="left" gap="5" pr={{base: 0, lg: 14}}>
            ...
            <Text fontSize="sm" color="dimmedText">
              ...
              <SimpleGrid px={{md:10, lg: 0}} textAlign="center" columns={[3, 3, 3]} spacingY="8" spacingX={{base: 4, md: 8}}>
                {
                  PROVIDERS.map((provider) => (
                    <Box w={{base: "132", md: "176"}}
                     textAlign="center">
                        <Box
          ...
          <Box color="dimmedText" textAlign={{base: "center", lg: "left"}} p={{base: 4, lg: 12}} flex="1">
              <Text fontSize="sm">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque,
                   et condimentum convallis ligula gravida at. Morbi nulla sed vel leo. 
